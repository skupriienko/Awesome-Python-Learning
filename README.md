...
[[Де, як і скільки: аналізуємо найм джуніорів у 2019 році \| DOU]{.underline}](https://dou.ua/lenta/articles/juniors-2019/?from=nl&utm_source=20200428&utm_medium=email&utm_campaign=CM)
...
[[Python Developers Survey 2019 Results \| JetBrains: Developer Tools for Professionals and Teams]{.underline}](https://www.jetbrains.com/lp/python-developers-survey-2019/?utm_source=Iterable&utm_medium=email&utm_campaign=newsletter_82)
...
[[AI For Everyone --- главная \| Coursera]{.underline}](https://www.coursera.org/learn/ai-for-everyone/home/welcome)
...
[[Big Data Analytics in Healthcare]{.underline}](https://www.udacity.com/course/big-data-analytics-in-healthcare--ud758)
...
[[Course \| CS1301xII \| edX]{.underline}](https://courses.edx.org/courses/course-v1:GTx+CS1301xII+3T2019/course/)
...
[[Data Visualization in Python --- DataCamp]{.underline}](https://www.datacamp.com/resources/webinars/data-visualization-in-python)
...
[[Explore - LeetCode]{.underline}](https://leetcode.com/explore/)
...
[[HTTP & Web Servers]{.underline}](https://www.udacity.com/course/http-web-servers--ud303)
...
[[Intro to Inferential Statistics]{.underline}](https://www.udacity.com/course/intro-to-inferential-statistics--ud201)
...
[[Introduction To Python Programming \| Udemy]{.underline}](https://www.udemy.com/course/pythonforbeginnersintro/learn/lecture/7717096#overview)
...
[[Learn Pandas Tutorials \| Kaggle]{.underline}](https://www.kaggle.com/learn/pandas)
...
[[Machine Learning Interview Preparation]{.underline}](https://www.udacity.com/course/machine-learning-interview-prep--ud1001)
...
[[Python \| CoderNet]{.underline}](https://codernet.ru/videos/python/)
...
[[R Language Playground \| Katacoda]{.underline}](https://www.katacoda.com/courses/rlang/playground)
...
[[Story by Data - YouTube]{.underline}](https://www.youtube.com/channel/UCU9GTVEPqlSNRDHypVf3BRw)
...
[[Video Lectures \| Mathematics for Computer Science \| Electrical Engineering and Computer Science \| MIT OpenCourseWare]{.underline}](https://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-042j-mathematics-for-computer-science-fall-2010/video-lectures/)
...
[[Бесплатное учебное руководство по теме \"Python\" --- Learn Python 3.6 for Total Beginners \| Udemy]{.underline}](https://www.udemy.com/course/python-3-for-total-beginners/?LSNPUBID=JVFxdTr9V80&ranEAID=JVFxdTr9V80&ranMID=39197&ranSiteID=JVFxdTr9V80-oM2ZIYMnMagUaWggNNt8Tg)
...
[[Машинное обучение для людей :: Разбираемся простыми словами :: Блог Вастрик.ру]{.underline}](https://vas3k.ru/blog/machine_learning/)
...
[[Разведочный анализ данных \| Coursera]{.underline}](https://www.coursera.org/learn/exploratory-data-analysis?siteID=SAyYsTvLiGQ-a6bPdq0USJFLoTVZMMv8Fw&utm_content=10&utm_medium=partners&utm_source=linkshare&utm_campaign=SAyYsTvLiGQ)
...
[[Build a Data Analysis Library from Scratch in Python - YouTube]{.underline}](https://www.youtube.com/playlist?list=PLVyhfExBT1XDTu-oocI3ttl_OPhulAJOp)
...
[[100 days of algorithms -- Medium]{.underline}](https://medium.com/100-days-of-algorithms)
...
[[NumPy Tutorial: Data Analysis with Python -- Dataquest]{.underline}](https://www.dataquest.io/blog/numpy-tutorial-python/)
...
[[Руководство Oracle PL/SQL]{.underline}](https://o7planning.org/ru/10313/oracle-pl-sql-programming-tutorial)
...
[[Eloquent JavaScript]{.underline}](https://eloquentjavascript.net/)
...
[[Tutorials --- pandas 1.0.3 documentation]{.underline}](https://pandas.pydata.org/pandas-docs/stable/getting_started/tutorials.html)
...
[[Play CodeCombat Levels - Learn Python, JavaScript, and HTML \| CodeCombat]{.underline}](https://codecombat.com/play/forest)
...
[[Упражнения по SQL]{.underline}](http://www.sql-ex.ru/index.php)
...
[[Machine Learning Projects \| Data Science Projects with Example]{.underline}](https://www.analyticsvidhya.com/blog/2018/05/24-ultimate-data-science-projects-to-boost-your-knowledge-and-skills/)
...
[[20 short tutorials all data scientists should read (and practice) - Data Science Central]{.underline}](https://www.datasciencecentral.com/profiles/blogs/17-short-tutorials-all-data-scientists-should-read-and-practice)
...
[[Building a Microservice in Python - Sonu Sharma - Medium]{.underline}](https://medium.com/@sonusharma.mnnit/building-a-microservice-in-python-ff009da83dac)
...
[[Dataset Search]{.underline}](https://datasetsearch.research.google.com/)
...
[[ekzhu/datasketch: MinHash, LSH, LSH Forest, Weighted MinHash, HyperLogLog, HyperLogLog++, LSH Ensemble]{.underline}](https://github.com/ekzhu/datasketch)

[[emmetio/emmet-atom: Emmet support for Atom]{.underline}](https://github.com/emmetio/emmet-atom#readme)

[[Erotemic/ubelt: A Python utility belt containing simple tools, a stdlib like feel, and extra batteries. Hashing, Caching, Timing, Progress, and more made easy!]{.underline}](https://github.com/Erotemic/ubelt?utm_source=mybridge&utm_medium=blog&utm_campaign=read_more)

[[Exploring your data with just 1 line of Python - Towards Data Science]{.underline}](https://towardsdatascience.com/exploring-your-data-with-just-1-line-of-python-4b35ce21a82d)

[[eyaltrabelsi/pandas-log: The goal of pandas-log is to provide feedback about basic pandas operations. It provides simple wrapper functions for the most common functions that add additional logs]{.underline}](https://github.com/eyaltrabelsi/pandas-log)

[[facebook/create-react-app: Set up a modern web app by running one command.]{.underline}](https://github.com/facebook/create-react-app)

[[facebookresearch/detectron2: Detectron2 is FAIR\'s next-generation platform for object detection and segmentation.]{.underline}](https://github.com/facebookresearch/detectron2)

[[facebookresearch/DrQA: Reading Wikipedia to Answer Open-Domain Questions]{.underline}](https://github.com/facebookresearch/DrQA)

[[facebookresearch/faiss: A library for efficient similarity search and clustering of dense vectors.]{.underline}](https://github.com/facebookresearch/faiss)

[[facebookresearch/fastMRI: A large-scale dataset of both raw MRI measurements and clinical MRI images]{.underline}](https://github.com/facebookresearch/fastMRI)

[[facebookresearch/habitat-api: A modular high-level library to train embodied AI agents across a variety of tasks, environments, and simulators.]{.underline}](https://github.com/facebookresearch/habitat-api)

[[facebookresearch/LAMA: LAnguage Model Analysis]{.underline}](https://github.com/facebookresearch/LAMA)

[[facebookresearch/nevergrad: A Python toolbox for performing gradient-free optimization]{.underline}](https://github.com/facebookresearch/nevergrad)

[[facebookresearch/pytext: A natural language modeling framework based on PyTorch]{.underline}](https://github.com/facebookresearch/pytext)

[[facebookresearch/pytorch\_GAN\_zoo: A mix of GAN implementations including progressive growing]{.underline}](https://github.com/facebookresearch/pytorch_GAN_zoo)

[[facebookresearch/VideoPose3D: Efficient 3D human pose estimation in video using 2D keypoint trajectories]{.underline}](https://github.com/facebookresearch/VideoPose3D)

[[facebookresearch/visdom: A flexible tool for creating, organizing, and sharing visualizations of live, rich data. Supports Torch and Numpy.]{.underline}](https://github.com/facebookresearch/visdom)

[[facebookresearch/vizseq: An Analysis Toolkit for Natural Language Generation (Translation, Captioning, Summarization, etc.)]{.underline}](https://github.com/facebookresearch/vizseq)

[[Getting started --- Flexx 1.0 documentation]{.underline}](https://flexx.readthedocs.io/en/latest/start.html)

[[Getting started --- HiPlot 0.1.9.post2 documentation]{.underline}](https://facebookresearch.github.io/hiplot/getting_started.html)

[[Getting started --- pandas 1.0.3 documentation]{.underline}](https://pandas.pydata.org/pandas-docs/stable/getting_started/index.html)

[[Getting started --- SciPy.org]{.underline}](https://www.scipy.org/getting-started.html)

[[Getting started with Django \| Django]{.underline}](https://www.djangoproject.com/start/)

[[Getting started with PyMC3 --- PyMC3 3.8 documentation]{.underline}](https://docs.pymc.io/notebooks/getting_started.html)

[[github/hub: A command-line tool that makes git easier to use with GitHub.]{.underline}](https://github.com/github/hub)

[[Graphene-Python]{.underline}](https://docs.graphene-python.org/en/latest/quickstart/)

[[great-expectations/great\_expectations: Always know what to expect from your data.]{.underline}](https://github.com/great-expectations/great_expectations)

[[gto76/python-cheatsheet: Comprehensive Python Cheatsheet]{.underline}](https://github.com/gto76/python-cheatsheet)

[[GUI (графический интерфейс пользователя) \| Python 3 для начинающих и чайников]{.underline}](https://pythonworld.ru/gui)

[[GuiProgramming - Python Wiki]{.underline}](https://wiki.python.org/moin/GuiProgramming)

[[Hello, App Center]{.underline}](https://appcenter.ms/apps)

[[How to deploy ML models using Flask + Gunicorn + Nginx + Docker]{.underline}](https://towardsdatascience.com/how-to-deploy-ml-models-using-flask-gunicorn-nginx-docker-9b32055b3d0)

[[How to Get a Job with Python - Towards Data Science]{.underline}](https://towardsdatascience.com/how-to-get-a-job-with-python-575f1b79fa11)

[[How to Install and Run Hadoop on Windows for Beginners - Data Science Central]{.underline}](https://www.datasciencecentral.com/profiles/blogs/how-to-install-and-run-hadoop-on-windows-for-beginners)

[[How to Update All Python Packages \| ActiveState]{.underline}](https://www.activestate.com/resources/quick-reads/how-to-update-all-python-packages/)

[[Installation --- Kivy 1.11.1 documentation]{.underline}](https://kivy.org/doc/stable/gettingstarted/installation.html)

[[Installation --- pyglet v1.5.0]{.underline}](https://pyglet.readthedocs.io/en/latest/programming_guide/installation.html)

[[Integrating Summernote WYSIWYG Editor in Django  \| Django Central]{.underline}](https://djangocentral.com/integrating-summernote-in-django/)

[[interpretml/interpret: Fit interpretable machine learning models. Explain blackbox machine learning.]{.underline}](https://github.com/interpretml/interpret)

[[Introducing Bamboolib --- a GUI for Pandas - Towards Data Science]{.underline}](https://towardsdatascience.com/introducing-bamboolib-a-gui-for-pandas-4f6c091089e3)

[[Introducing GitFlow]{.underline}](https://datasift.github.io/gitflow/IntroducingGitFlow.html)

[[ipinfo.io/json]{.underline}](http://ipinfo.io/json)

[[ironmussa/Optimus at develop-3.0]{.underline}](https://github.com/ironmussa/Optimus/tree/develop-3.0)

[[japronto/1\_hello.md at master · squeaky-pl/japronto]{.underline}](https://github.com/squeaky-pl/japronto/blob/master/tutorial/1_hello.md)

[[jaybaird/python-bloomfilter: Scalable Bloom Filter implemented in Python]{.underline}](https://github.com/jaybaird/python-bloomfilter)

[[jazzband/pip-tools: A set of tools to keep your pinned Python dependencies fresh.]{.underline}](https://github.com/jazzband/pip-tools)

[[Jetware - aise / tensorflow18\_keras21\_python36\_cpu\_notebook - 180509 appliance]{.underline}](http://jetware.io/appliances/aise/tensorflow18_keras21_python36_cpu_notebook)

[[jiffyclub/snakeviz: An in-browser Python profile viewer]{.underline}](https://github.com/jiffyclub/snakeviz)

[[JS Bin - Collaborative JavaScript Debugging]{.underline}](http://jsbin.com/?html,output)

[[Keras Cheat Sheet: Neural Networks in Python - DataCamp]{.underline}](https://www.datacamp.com/community/blog/keras-cheat-sheet)

[[keyboard-shortcuts-windows.pdf]{.underline}](https://code.visualstudio.com/shortcuts/keyboard-shortcuts-windows.pdf)

[[knockknock/README.md at master · huggingface/knockknock]{.underline}](https://github.com/huggingface/knockknock/blob/master/README.md/)

[[Laravel Nova - Beautifully-designed administration panel for Laravel]{.underline}](https://nova.laravel.com/)

[[localhost:54321/callback?code=b7e3a07c1695c5b58b6d]{.underline}](http://localhost:54321/callback?code=b7e3a07c1695c5b58b6d)

[[Machine Learning]{.underline}](http://www.machinelearning.ru/wiki/index.php?title=%D0%97%D0%B0%D0%B3%D0%BB%D0%B0%D0%B2%D0%BD%D0%B0%D1%8F_%D1%81%D1%82%D1%80%D0%B0%D0%BD%D0%B8%D1%86%D0%B0)

[[main]{.underline}](https://repo.anaconda.com/pkgs/main/)

[[marcotcr/lime: Lime: Explaining the predictions of any machine learning classifier]{.underline}](https://github.com/marcotcr/lime)

[[MIT App Inventor 2]{.underline}](http://ai2.appinventor.mit.edu/?locale=ru&repo=http%3A%2F%2Fappinventor.mit.edu%2Fyrtoolkit%2Fyr%2FaiaFiles%2FmoodCounter%2Fyr_mood_starter.asc#6567580202041344)

[[More Itertools --- more-itertools 8.2.0 documentation]{.underline}](https://more-itertools.readthedocs.io/en/stable/index.html)

[[mouradmourafiq/pandas-summary: An extension to pandas dataframes describe function.]{.underline}](https://github.com/mouradmourafiq/pandas-summary)

[[Native mobile apps with Angular, Vue.js, TypeScript, JavaScript - NativeScript]{.underline}](https://www.nativescript.org/)

[[nicolaskruchten/pivottable: Open-source Javascript Pivot Table (aka Pivot Grid, Pivot Chart, Cross-Tab) implementation with drag\'n\'drop.]{.underline}](https://github.com/nicolaskruchten/pivottable)

[[NLTK Data]{.underline}](http://www.nltk.org/nltk_data/)

[[NoSQL Databases List by Hosting Data - Updated 2020]{.underline}](https://hostingdata.co.uk/nosql-database/)

[[Numba: A High Performance Python Compiler]{.underline}](http://numba.pydata.org/)

[[Numpy and Scipy Documentation --- Numpy and Scipy documentation]{.underline}](https://docs.scipy.org/doc/)

[[NumPy в Python. Часть 1 / Хабр]{.underline}](https://habr.com/ru/post/352678/)

[[Optimus/README.md at master · ironmussa/Optimus]{.underline}](https://github.com/ironmussa/Optimus/blob/master/README.md)

[[Over 150 of the Best Machine Learning, NLP, and Python Tutorials I've Found]{.underline}](https://medium.com/machine-learning-in-practice/over-150-of-the-best-machine-learning-nlp-and-python-tutorials-ive-found-ffce2939bd78)

[[Overview --- Matplotlib 3.2.1 documentation]{.underline}](https://matplotlib.org/contents.html)

[[Overview --- NumPy v1.19.dev0 Manual]{.underline}](https://numpy.org/devdocs/)

[[PageSpeed Insights]{.underline}](https://developers.google.com/speed/pagespeed/insights/?hl=uk&url=https%3A%2F%2Fkuprienko.info%2F&tab=desktop)

[[pallets/werkzeug: The comprehensive WSGI web application library.]{.underline}](https://github.com/pallets/werkzeug)

[[Pivot Demo From Local CSV]{.underline}](https://pivottable.js.org/examples/local.html)

[[PivotTable.js]{.underline}](https://pivottable.js.org/examples/index.html)

[[Plotting Google Sheets data in Python with Folium - Towards Data Science]{.underline}](https://towardsdatascience.com/plotting-crowdsourced-data-with-google-sheets-and-folium-6c9edbef2bb8)

[[Plugin Status · WakaTime]{.underline}](https://wakatime.com/plugins/status?onboarding=true)

[[Polymer Project]{.underline}](https://www.polymer-project.org/)

[[Popper - Tooltip & Popover Positioning Engine]{.underline}](https://popper.js.org/)

[[PostgreSQL : Документация : Компания Postgres Professional]{.underline}](https://postgrespro.ru/docs/postgresql)

[[Prisma - Database tools for modern application development]{.underline}](https://www.prisma.io/)

[[Projects - Home]{.underline}](https://dev.azure.com/kupriienko/)

[[pydqc/README.md at master · SauceCat/pydqc]{.underline}](https://github.com/SauceCat/pydqc/blob/master/README.md)

[[PyQt5 book with a foreword by the creator of PyQt]{.underline}](https://build-system.fman.io/pyqt5-book)

[[Pythia's Documentation --- Pythia 0.3 documentation]{.underline}](https://learnpythia.readthedocs.io/en/latest/)

[[Python 3.8 documentation --- DevDocs]{.underline}](https://devdocs.io/python~3.8/)

[[Python Extension Packages for Windows - Christoph Gohlke]{.underline}](https://www.lfd.uci.edu/~gohlke/pythonlibs/)

[[Python Frameworks Comparison: How to Choose the Best for Web Development]{.underline}](https://medium.com/better-programming/python-frameworks-comparison-how-to-choose-the-best-for-web-development-9603107ec905)

[[Python в три ручья: работаем с потоками (часть 1) \| GeekBrains - образовательный портал]{.underline}](https://geekbrains.ru/posts/python_threading_part1)

[[pytorch3d/INSTALL.md at master · facebookresearch/pytorch3d]{.underline}](https://github.com/facebookresearch/pytorch3d/blob/master/INSTALL.md)

[[Qt Designer Download for Windows and Mac]{.underline}](https://build-system.fman.io/qt-designer-download)

[[Quick Start \| GatsbyJS]{.underline}](https://www.gatsbyjs.org/docs/quick-start/)

[[Quick Start · gulp.js]{.underline}](https://gulpjs.com/docs/en/getting-started/quick-start)

[[Quickstart for Python/WSGI applications --- uWSGI 2.0 documentation]{.underline}](https://uwsgi-docs.readthedocs.io/en/latest/WSGIquickstart.html)

[[Quickstart tutorial --- NumPy v1.19.dev0 Manual]{.underline}](https://numpy.org/devdocs/user/quickstart.html)

[[R Packages - RStudio]{.underline}](https://rstudio.com/products/rpackages/)

[[RaRe-Technologies/bounter: Efficient Counter that uses a limited (bounded) amount of memory regardless of data size.]{.underline}](https://github.com/RaRe-Technologies/bounter)

[[React -- JavaScript-бібліотека для створення користувацьких інтерфейсів]{.underline}](https://uk.reactjs.org/)

[[Roundup of Python NLP Libraries - NLP-FOR-HACKERS]{.underline}](https://nlpforhackers.io/libraries/)

[[samuelhwilliams/Eel: A little Python library for making simple Electron-like HTML/JS GUI apps]{.underline}](https://github.com/samuelhwilliams/Eel?utm_source=mybridge&utm_medium=blog&utm_campaign=read_more)

[[SciPy --- SciPy v1.4.1 Reference Guide]{.underline}](https://docs.scipy.org/doc/scipy/reference/)

[[SciPy.org --- SciPy.org]{.underline}](https://www.scipy.org/)

[[Settings \| Account · WakaTime]{.underline}](https://wakatime.com/settings/account)

[[shaypal5/cachier: Persistent, stale-free, local and cross-machine caching for Python functions.]{.underline}](https://github.com/shaypal5/cachier)

[[sindresorhus/awesome: 😎 Awesome lists about all kinds of interesting topics]{.underline}](https://github.com/sindresorhus/awesome)

[[skromnitsky/My\_Projects]{.underline}](https://github.com/skromnitsky/My_Projects)

[[Speech Recognition - Speech to Text in Python using Google API, Wit.AI, IBM, CMUSphinx]{.underline}](https://www.pragnakalp.com/speech-recognition-speech-to-text-python-using-google-api-wit-ai-ibm-cmusphinx/)

[[Speed Up your Algorithms Part 2--- Numba - Towards Data Science]{.underline}](https://towardsdatascience.com/speed-up-your-algorithms-part-2-numba-293e554c5cc1)

[[Speeding up your Algorithms Part 4--- Dask - Towards Data Science]{.underline}](https://towardsdatascience.com/speeding-up-your-algorithms-part-4-dask-7c6ed79994ef)

[[Stop Worrying and Create your Deep Learning Server in 30 minutes]{.underline}](https://towardsdatascience.com/stop-worrying-and-create-your-deep-learning-server-in-30-minutes-bb5bd956b8de)

[[streamlit/streamlit: Streamlit --- The fastest way to build custom ML tools]{.underline}](https://github.com/streamlit/streamlit)

[[Superbird11/ranges: Continuous Range, RangeSet, and RangeDict data structures for Python]{.underline}](https://github.com/Superbird11/ranges)

[[The 30 Best Python Libraries and Packages for Beginners]{.underline}](https://www.ubuntupit.com/best-python-libraries-and-packages-for-beginners/)

[[The Basics of Data Visualisation with Python - Towards Data Science]{.underline}](https://towardsdatascience.com/the-basics-of-data-visualisation-with-python-23188aa9fc1a)

[[The Big Bad NLP Database: Access Nearly 300 Datasets]{.underline}](https://www.kdnuggets.com/2020/02/big-bad-nlp-database.html)

[[The Coolest Data Science And Machine Learning Tool Companies Of The 2020 Big Data 100]{.underline}](https://www.crn.com/slide-shows/cloud/the-coolest-data-science-and-machine-learning-tool-companies-of-the-2020-big-data-100)

[[The Most Underrated Python Packages - Towards Data Science]{.underline}](https://towardsdatascience.com/the-most-underrated-python-packages-e22bf6049b5e)

[[The Super Duper NLP Repo: 100 Ready-to-Run Colab Notebooks]{.underline}](https://www.kdnuggets.com/2020/04/super-duper-nlp-repo.html)

[[Tkinter. Программирование GUI на Python. Курс]{.underline}](https://younglinux.info/tkinter.php)

[[Top Python Libraries Used In Data Science - Towards Data Science]{.underline}](https://towardsdatascience.com/top-python-libraries-used-in-data-science-a58e90f1b4ba)

[[tqdm/tqdm: A Fast, Extensible Progress Bar for Python and CLI]{.underline}](https://github.com/tqdm/tqdm)

[[Travis CI]{.underline}](https://travis-ci.org/account/repositories)

[[Travis CI - Test and Deploy with Confidence]{.underline}](https://travis-ci.com/dashboard)

[[Turn Python Scripts into Beautiful ML Tools - Towards Data Science]{.underline}](https://towardsdatascience.com/coding-ml-tools-like-you-code-ml-models-ddba3357eace)

[[Tutorial --- ZODB documentation]{.underline}](http://www.zodb.org/en/latest/tutorial.html#installation)

[[Tutorial: Web Scraping in R with rvest -- Dataquest]{.underline}](https://www.dataquest.io/blog/web-scraping-in-r-rvest/)

[[ucg8j/awesome-dash: A curated list of awesome Dash (plotly) resources]{.underline}](https://github.com/ucg8j/awesome-dash)

[[umdjs/umd: UMD (Universal Module Definition) patterns for JavaScript modules that work everywhere.]{.underline}](https://github.com/umdjs/umd)

[[Understanding the GitHub flow · GitHub Guides]{.underline}](https://guides.github.com/introduction/flow/)

[[Untitled Diagram - diagrams.net]{.underline}](https://app.diagrams.net/)

[[Untitled Document - Creately]{.underline}](https://app.creately.com/diagram/7J75Ibgfcn3/edit)

[[Usage · s0md3v/XSStrike Wiki]{.underline}](https://github.com/s0md3v/XSStrike/wiki/Usage)

[[User\'s Guide --- Matplotlib 3.2.1 documentation]{.underline}](https://matplotlib.org/users/index.html)

[[vaexio/vaex: Out-of-Core DataFrames for Python, ML, visualize and explore big tabular data at a billion rows per second 🚀]{.underline}](https://github.com/vaexio/vaex)

[[vinta/awesome-python: A curated list of awesome Python frameworks, libraries, software and resources]{.underline}](https://github.com/vinta/awesome-python)

[[vstinner/pyperf: Toolkit to run Python benchmarks]{.underline}](https://github.com/vstinner/pyperf)

[[vue.js]{.underline}](file:///E:\Downloads\vue.js)

[[vue.min.js]{.underline}](file:///E:\Downloads\vue.min.js)

[[W3Schools Online Web Tutorials]{.underline}](https://www.w3schools.com/)

[[WAVE Report of Мої книги \| KUPRIENKO]{.underline}](https://wave.webaim.org/report#/kuprienko.info)

[[Web technology for developers \| MDN]{.underline}](https://developer.mozilla.org/en-US/docs/Web)

[[WebAssembly]{.underline}](https://webassembly.org/)

[[Website Style Guide Resources]{.underline}](http://styleguides.io/)

[[Welcome to pyjanitor's documentation! --- pyjanitor documentation]{.underline}](https://pyjanitor.readthedocs.io/)

[[Welcome to SymPy's documentation! --- SymPy 1.5.1 documentation]{.underline}](https://docs.sympy.org/latest/index.html)

[[What is Azure Machine Learning \| Microsoft Docs]{.underline}](https://docs.microsoft.com/en-us/azure/machine-learning/overview-what-is-azure-ml)

[[Which movie should I watch? - Nishant Sahoo - Medium]{.underline}](https://medium.com/@nishantsahoo/which-movie-should-i-watch-5c83a3c0f5b1)

[[Wolfram Client Library for Python --- Wolfram Client Library for Python 1.1.0 documentation]{.underline}](https://reference.wolfram.com/language/WolframClientForPython/)

[[Wolfram\|Alpha: Computational Intelligence]{.underline}](https://www.wolframalpha.com/)

[[Yii PHP Framework]{.underline}](https://www.yiiframework.com/)

[[Zsailer/pandas\_flavor: The easy way to write your own flavor of Pandas]{.underline}](https://github.com/Zsailer/pandas_flavor)

[[Введение в потоки в Python - Еще один блог веб разработчика]{.underline}](https://webdevblog.ru/vvedenie-v-potoki-v-python/)

[[Введение в создание веб-приложений на Python]{.underline}](https://proglib.io/p/python-web-development/)

[[Вступ · Django Girls Tutorial]{.underline}](https://tutorial.djangogirls.org/uk/)

[[Глава 1: Создание первого приложения · Django в примерах]{.underline}](https://pocoz.gitbooks.io/django-v-primerah/content/)

[[Данные важнее, чем модели. Как выглядят эффективные процессы в Data Science \| DOU]{.underline}](https://dou.ua/lenta/articles/data-scientists-workflow/)

[[Искусственная нейронная сеть с нуля на Python c библиотекой NumPy]{.underline}](https://neurohive.io/ru/tutorial/nejronnaja-set-na-numpy/)

[[Как написать цепляющую вакансию на ДОУ \| DOU]{.underline}](https://dou.ua/forums/topic/30281/?from=comment-digest_bc&utm_source=transactional&utm_medium=email&utm_campaign=digest-comments#1830892)

[[Как оформить профиль на GitHub так, чтобы он работал при поиске работы \| DOU]{.underline}](https://dou.ua/lenta/articles/github-profile-for-beginners/?from=comment-digest_bc&utm_source=transactional&utm_medium=email&utm_campaign=digest-comments#1846411)

[[Как получить 100/100 в Google Page Speed Test Tool? --- SEO компания UAWEB]{.underline}](https://uaweb.ua/publication/google_page_speed_test_tool.html)

[[Как установить Django, Nginx и Gunicorn на виртуальный сервер]{.underline}](https://1cloud.ru/help/linux/ustanovka-django-s-postgresql-nginx-i-gunicorn-na-ubuntu-18-04)

[[Краткое руководство по Dash --- Python веб-фреймворк для создания дэшбордов. Installation + Dash Layout / Хабр]{.underline}](https://habr.com/ru/post/431754/)

[[Курс «Hacking PostgreSQL» : Компания Postgres Professional]{.underline}](https://postgrespro.ru/education/courses/hacking)

[[Лучшие датасеты для машинного обучения и анализа данных]{.underline}](https://tproger.ru/translations/the-best-datasets-for-machine-learning-and-data-science/)

[[Мега-Учебник Flask, Часть 1: «Привет, Мир!» / Хабр]{.underline}](https://habr.com/ru/post/193242/)

[[Многопоточность в Python]{.underline}](https://bablofil.ru/python-multithreading/)

[[Многопоточность в Python. Библиотеки threading и multiprocessing.]{.underline}](http://cs.mipt.ru/advanced_python/lessons/lab6.html)

[[Многопоточность на примерах - модуль threading]{.underline}](https://python-scripts.com/threading)

[[Настраиваем Django + virtualenv + nginx + gunicorn + PostgreSQL + memcached + letsencrypt на Ubuntu 16.04 \| Python 3 для начинающих и чайников]{.underline}](https://pythonworld.ru/web/django-ubuntu1604.html)

[[Настройка Django с Postgres, Nginx и Gunicorn в Ubuntu 18.04 \| DigitalOcean]{.underline}](https://www.digitalocean.com/community/tutorials/how-to-set-up-django-with-postgres-nginx-and-gunicorn-on-ubuntu-18-04-ru)

[[Настройка веб-сервера для Django с nginx и uWSGI - Как стать программистом]{.underline}](http://itman.in/django-webserver-nginx-uwsgi/)

[[Обработка естественного языка: с чего начать и что изучать дальше]{.underline}](https://proglib.io/p/how-to-start-nlp/)

[[Объектно-ориентированное Программирование в Python]{.underline}](https://python-scripts.com/object-oriented-programming-in-python#attributes)

[[Описания паттернов проектирования. Паттерны проектирования. Шаблоны проектирования на Design pattern ru]{.underline}](http://design-pattern.ru/patterns/)

[[Перші кроки в NLP: розглядаємо Python-бібліотеку TensorFlow та нейронні мережі в реальному завданні \| DOU]{.underline}](https://dou.ua/lenta/articles/first-steps-in-nlp-tensorflow/?from=comment-digest_post&utm_source=transactional&utm_medium=email&utm_campaign=digest-comments)

[[Почему CSS Grid лучше, чем фреймворк Bootstrap?]{.underline}](https://proglib.io/p/css-grid-vs-bootstrap/)

[[Почему Python хорош для Data Science и разработки приложений]{.underline}](https://tproger.ru/articles/python-for-software-development-and-data-science/)

[[Предсказываем будущее с помощью библиотеки Facebook Prophet / Блог компании Open Data Science / Хабр]{.underline}](https://habr.com/ru/company/ods/blog/323730/)

[[Примеры использования Python-библиотеки NumPy \| Записки программиста]{.underline}](https://eax.me/python-numpy/)

[[Скринкаст по Git]{.underline}](https://learn.javascript.ru/screencast/git)

[[Создаем простой калькулятор в PyQt5]{.underline}](https://python-scripts.com/pyqt5-calculator)

[[Создание графического интерфейса на Python 3 с Tkinter \~ PythonRu]{.underline}](https://pythonru.com/uroki/obuchenie-python-gui-uroki-po-tkinter)

[[Учимся писать многопоточные и многопроцессные приложения на Python / Хабр]{.underline}](https://habr.com/ru/post/149420/)

[[Фичи Django ORM, о которых вы не знали]{.underline}](https://tproger.ru/translations/django-orm-tips/)

[[Что такое NGINX. NGINX простыми словами]{.underline}](https://www.dmosk.ru/terminus.php?object=nginx)

### **Articles about Software Engineering**

[[10 Data Structure, Algorithms, and Programming Courses to Crack Any Coding Interview]{.underline}](https://medium.com/hackernoon/10-data-structure-algorithms-and-programming-courses-to-crack-any-coding-interview-e1c50b30b927)

[[10 Programming Best Practices to Name Variables, Methods, Classes and Packages]{.underline}](https://javarevisited.blogspot.com/2014/10/10-java-best-practices-to-name-variables-methods-classes-packages.html#axzz5Bwn8nSNW)

[[10 советов для обучающихся программированию]{.underline}](https://proglib.io/p/learn-to-code/)

[[10 структур данных, которые вы должны знать (+видео и задания)]{.underline}](https://proglib.io/p/data-structures/)

[[11 must-have алгоритмов машинного обучения для Data Scientist]{.underline}](https://proglib.io/p/11-ml-algorithms/)

[[26 полезных возможностей Python: букварь разработки от А до Z]{.underline}](https://proglib.io/p/a-z-python/)

[[27 шпаргалок по машинному обучению и Python в 2017]{.underline}](https://proglib.io/p/ds-cheatsheets/)

[[28 cайтов, на которых можно порешать задачи по программированию]{.underline}](https://tproger.ru/digest/competitive-programming-practice/)

[[35 лучших сайтов для самообразования]{.underline}](https://proglib.io/p/35-websites-to-learn/)

[[4. More Control Flow Tools --- Python 3.8.2 documentation]{.underline}](https://docs.python.org/3/tutorial/controlflow.html#defining-functions)

[[5 популярных IDE для программирования на C++]{.underline}](https://tproger.ru/digest/5-cpp-ide/)

[[5 сайтов для оттачивания навыков написания SQL-запросов]{.underline}](https://proglib.io/p/sql-practice-sites/)

[[58 подкастов для программистов]{.underline}](https://proglib.io/p/it-podcasts/)

[[7 эффективных способов зарабатывать на искусственном интеллекте]{.underline}](https://proglib.io/p/make-money-with-ai/)

[[7. Input and Output --- Python 3.8.2 documentation]{.underline}](https://docs.python.org/3/tutorial/inputoutput.html#reading-and-writing-files)

[[9 новых технологий, которые вы можете освоить за лето и стать ценнее на рынке труда]{.underline}](https://tproger.ru/digest/9-new-technologies/)

[[9. Classes --- Python 3.6.10 documentation]{.underline}](https://docs.python.org/3.6/tutorial/classes.html)

[[Advanced Python made easy - Quick Code - Medium]{.underline}](https://medium.com/quick-code/advanced-python-made-easy-eece317334fa)

[[AlgoList - алгоритмы, методы, исходники]{.underline}](http://algolist.ru/)

[[Built-in Functions --- Python 3.8.2 documentation]{.underline}](https://docs.python.org/3/library/functions.html)

[[Decorators --- Python 3 Patterns, Recipes and Idioms]{.underline}](https://python-3-patterns-idioms-test.readthedocs.io/en/latest/PythonDecorators.html)

[[Django или Ruby on Rails: какой фреймворк выбрать?]{.underline}](https://tproger.ru/translations/django-or-ruby-on-rails/)

[[DOU Проектор: Homemade Machine Learning --- репозиторий для изучения ML на Python с Jupyter-демо \| DOU]{.underline}](https://dou.ua/lenta/articles/dou-projector-homemade-machine-learning/)

[[DOU Проектор: репозиторий на GitHub --- шпаргалка для изучения Python \| DOU]{.underline}](https://dou.ua/lenta/articles/dou-projector-playground-for-learning-python/)

[[ES6: прокси изнутри --- CSS-LIVE]{.underline}](https://css-live.ru/articles/es6-proksi-iznutri.html)

[[FeatureSelector: отбор признаков для машинного обучения на Python]{.underline}](https://proglib.io/p/feature-selector/)

[[Functional Programming HOWTO --- Python 3.8.2 documentation]{.underline}](https://docs.python.org/3/howto/functional.html)

[[functools --- Higher-order functions and operations on callable objects --- Python 3.8.2 documentation]{.underline}](https://docs.python.org/3/library/functools.html)

[[Haskell и хождение в базы данных с помощью HDBC \| Записки программиста]{.underline}](https://eax.me/haskell-hdbc/)

[[Home - Quora]{.underline}](https://www.quora.com/)

[[HTML / CSS Basics]{.underline}](https://slides.com/sergeyshalyapin/html_css_basics#/11)

[[Imperative vs Declarative Programming]{.underline}](https://tylermcginnis.com/imperative-vs-declarative-programming/)

[[Lecture 01. Motivation, What is a DBMS? (2015/01/20) (CS 186, Spring 2015, UC Berkeley) - YouTube]{.underline}](https://www.youtube.com/watch?v=IZmWm9YP_kg&list=PLItyOfErSadfnXtWkFX5yA7PQ8j8ZpORE)

[[Master the JavaScript Interview: What is Functional Programming?]{.underline}](https://medium.com/javascript-scene/master-the-javascript-interview-what-is-functional-programming-7f218c68b3a0)

[[melanierichards/just-build-websites: Some ideas for websites you can build!]{.underline}](https://github.com/melanierichards/just-build-websites)

[[miguelgrinberg.com]{.underline}](https://blog.miguelgrinberg.com/)

[[NumPy \| Python 3 для начинающих и чайников]{.underline}](https://pythonworld.ru/numpy)

[[Object Detection: как написать Hello World приложениe \| DOU]{.underline}](https://dou.ua/lenta/articles/object-detection/)

[[Papers]{.underline}](http://dsrg.pdos.csail.mit.edu/papers/)

[[PHP 25 лет: почему он именно такой и что с ним будет --- рассказывает создатель языка]{.underline}](https://tproger.ru/video/25-years-of-php/?autoplay=1)

[[Prototype-based programming - Wikipedia]{.underline}](https://en.wikipedia.org/wiki/Prototype-based_programming)

[[Python and Data Science Tutorial in Visual Studio Code]{.underline}](https://code.visualstudio.com/docs/python/data-science-tutorial)

[[Python Tutorial: Class vs. Instance Attributes]{.underline}](https://www.python-course.eu/python3_class_and_instance_attributes.php)

[[Python Tutorial: Object Oriented Programming]{.underline}](https://www.python-course.eu/python3_object_oriented_programming.php)

[[Python Tutorial: Properties vs. getters and setters]{.underline}](https://www.python-course.eu/python3_properties.php)

[[Python для Data Science: 8 понятий, которые важно помнить]{.underline}](https://proglib.io/p/python-data-science/)

[[Python/Объектно-ориентированное программирование на Python --- Викиучебник]{.underline}](https://ru.wikibooks.org/wiki/Python/%D0%9E%D0%B1%D1%8A%D0%B5%D0%BA%D1%82%D0%BD%D0%BE-%D0%BE%D1%80%D0%B8%D0%B5%D0%BD%D1%82%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D0%BD%D0%BD%D0%BE%D0%B5_%D0%BF%D1%80%D0%BE%D0%B3%D1%80%D0%B0%D0%BC%D0%BC%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5_%D0%BD%D0%B0_Python)

[[Sorting HOW TO --- Python 3.8.2 documentation]{.underline}](https://docs.python.org/3/howto/sorting.html)

[[SQL против NoSQL на примере MySQL и MongoDB]{.underline}](https://tproger.ru/translations/sql-vs-nosql/)

[[SQLite, MySQL и PostgreSQL: сравниваем популярные реляционные СУБД]{.underline}](https://tproger.ru/translations/sqlite-mysql-postgresql-comparison/)

[[swirl: Learn R, in R.]{.underline}](https://swirlstats.com/)

[[The Best Format to Save Pandas Data - Towards Data Science]{.underline}](https://towardsdatascience.com/the-best-format-to-save-pandas-data-414dca023e0d)

[[Time Management Skills and Training from MindTools.com]{.underline}](https://www.mindtools.com/pages/main/newMN_HTE.htm)

[[Top 15 Python Libraries for Data Science in 2017 - ActiveWizards --- AI & ML for startups - Medium]{.underline}](https://medium.com/activewizards-machine-learning-company/top-15-python-libraries-for-data-science-in-in-2017-ab61b4f9b4a7)

[[Top 8 Python Libraries for Data Science, Machine Learning, and Artificial Intelligence]{.underline}](https://javarevisited.blogspot.com/2018/10/top-8-python-libraries-for-data-science-machine-learning.html)

[[Top Ranked Articles - CodeProject]{.underline}](https://www.codeproject.com/script/Articles/TopArticles.aspx?ta_so=5)

[[Tproger]{.underline}](https://tproger.ru/)

[[Understanding JavaScript's async await]{.underline}](https://ponyfoo.com/articles/understanding-javascript-async-await)

[[What happens if you write a TCP stack in Python? - Julia Evans]{.underline}](https://jvns.ca/blog/2014/08/12/what-happens-if-you-write-a-tcp-stack-in-python/)

[[Write Professional Unit Tests in Python]{.underline}](https://code.tutsplus.com/tutorials/write-professional-unit-tests-in-python--cms-25835)

[[Алгоритм сортировки Timsort / Блог компании Инфопульс Украина / Хабр]{.underline}](https://habr.com/ru/company/infopulse/blog/133303/)

[[Алгоритмы и структуры данных --- всё по этой теме для программистов]{.underline}](https://tproger.ru/tag/algos-and-data-structs/)

[[Алгоритмы и структуры данных: развернутый видеокурс]{.underline}](https://proglib.io/p/data-structure-algorithms/)

[[Бесплатные материалы для программистов]{.underline}](https://tproger.ru/articles/free-programming-books/)

[[Библиотека Numpy. Полезные инструменты]{.underline}](https://devpractice.ru/numpy-useful-functions/)

[[Большая подборка материалов по машинному обучению: книги, видеокурсы, онлайн-курсы]{.underline}](https://proglib.io/p/learning-ml/)

[[Большая подборка ресурсов для изучения Android-разработки]{.underline}](https://tproger.ru/digest/master-android-development/)

[[Быстрый старт в Java: от установки необходимого софта до первой программы]{.underline}](https://tproger.ru/articles/start-writing-in-java/)

[[Введение в глубинное обучение]{.underline}](https://proglib.io/p/intro-to-deep-learning/)

[[Визуальное пояснение JOIN\'ов на SQL :: Блог Вастрик.ру]{.underline}](https://vas3k.ru/blog/97/)

[[Где программисту-новичку найти упражнения и идеи для проектов?]{.underline}](https://tproger.ru/translations/where-to-find-ideas/)

[[Еженедельная подборка свежих и самых значимых новостей o Python]{.underline}](https://pythondigest.ru/)

[[Зачем аналитикам данных знать SQL]{.underline}](https://tproger.ru/blogs/why-data-analysts-need-sql/)

[[Из армии в IT или как я стал С\# разработчиком с помощью JavaRush]{.underline}](https://javarush.ru/groups/posts/2466-iz-armii-v-it-ili-kak-ja-stal-dotnet-razrabotchikom-s-pomojshjhju-javarush)

[[Изобретаем JPEG / Хабр]{.underline}](https://habr.com/ru/post/206264/)

[[Изучаем алгоритмы: полезные книги, веб-сайты, онлайн-курсы и видеоматериалы]{.underline}](https://proglib.io/p/awesome-algorithms/)

[[Как выучить TypeScript за 2 дня и почему стоит начать прямо сейчас: опыт автора Tproger]{.underline}](https://tproger.ru/articles/how-to-learn-typescript/)

[[Как начать разрабатывать под Android]{.underline}](https://tproger.ru/translations/how-to-start-android/)

[[Как понять, что у тебя глубокие знания в JavaScript]{.underline}](https://proglib.io/p/deep-js/)

[[Как попасть в IT после 30]{.underline}](https://proglib.io/p/it-after-thirty/)

[[Как правильно искать и читать научные статьи?]{.underline}](https://proglib.io/p/research-papers/)

[[Как разобраться в Computer Science самостоятельно]{.underline}](https://tproger.ru/curriculum/computer-science-step-by-step/)

[[Как стать Junior-разработчиком и устроиться на работу за 4 месяца]{.underline}](https://proglib.io/p/junior-developer/)

[[Книги по программированию на Java. Книги для Джава программиста]{.underline}](https://tproger.ru/books/java-free-advanced-books/)

[[Курс Harvard CS50 - Лекция: Библиотеки Си]{.underline}](https://javarush.ru/quests/lectures/questharvardcs50.level01.lecture13)

[[Меняем схему базы данных в PostrgreSQL, не останавливая работу приложения]{.underline}](https://tproger.ru/translations/postgres-ddl-without-downtime/)

[[Начало работы с PostgreSQL \| Записки программиста]{.underline}](https://eax.me/postgresql-install/)

[[Нові записи на тему «Python» --- Стрічка \| DOU]{.underline}](https://dou.ua/lenta/tags/Python/)

[[Нюансы перехода на Kotlin, или Руководство для Android-разработчика по предательству Java]{.underline}](https://tproger.ru/articles/switch-from-java-to-kotlin/)

[[Объяснение взаимодействия методов (для новичков)]{.underline}](https://javarush.ru/groups/posts/2659-prosteyshee-obhhjasnenie-vzaimodeystvija-metodov-dlja-novichkov?utm_source=eSputnik-$email-digest&utm_medium=email&utm_campaign=$email-digest-36-active-user&utm_content=788825223)

[[Основные команды SQL, которые должен знать каждый программист]{.underline}](https://tproger.ru/translations/sql-recap/)

[[От новичка до профи в машинном обучении за 3 месяца]{.underline}](https://proglib.io/p/ml-3months/)

[[Паттерны проектирования на Python]{.underline}](https://refactoring.guru/ru/design-patterns/python)

[[Подборка бесплатных курсов с Coursera, которые прокачают ваш скилл в программировании]{.underline}](https://tproger.ru/digest/it-programming-courses/)

[[Подборка книг для начинающих Java-программистов]{.underline}](https://tproger.ru/books/java-free-beginners-books/)

[[Подборка книг по программированию на Python (Питон)]{.underline}](https://tproger.ru/books/free-python-books/)

[[Подборка материалов для изучения баз данных и SQL]{.underline}](https://proglib.io/p/sql-digest/)

[[Подборка материалов для начинающего Enterprise разработчика]{.underline}](https://tproger.ru/digest/enterprise-junior/)

[[Подборка материалов по нейронным сетям]{.underline}](https://proglib.io/p/neural-networks-digest/)

[[Подборка фильмов для айтишников: что посмотреть после работы]{.underline}](https://tproger.ru/digest/films/)

[[Почему многие программисты считают PHP плохим языком? --- отвечают эксперты]{.underline}](https://tproger.ru/experts/why-php-is-considered-bad/)

[[Привет, весна: пишем Hello World на Spring MVC]{.underline}](https://tproger.ru/translations/hello-world-spring/)

[[Программа минимум: что должен знать начинающий C\# программист]{.underline}](https://tproger.ru/translations/csharp-basic-skills/)

[[Программисты, учите статистику или я вас поубиваю!]{.underline}](https://tproger.ru/translations/programmers-need-to-learn-statistics-or-i-will-kill-them-all/)

[[Работа с данными по-новому: Pandas вместо SQL]{.underline}](https://tproger.ru/translations/rewrite-sql-queries-in-pandas/)

[[Работа с документацией в Python: поиск информации и соглашения]{.underline}](https://proglib.io/p/python-docs/)

[[Разбираемся в алгоритмах и структурах данных. Доступно и понятно \| DOU]{.underline}](https://dou.ua/lenta/articles/what-you-should-know-about-algorithms/)

[[Руководство по Java 9: компиляция и запуск проекта]{.underline}](https://tproger.ru/translations/java-9-guide-compile-run/)

[[Руководство по изучению языка R и его использование в Data Science]{.underline}](https://proglib.io/p/data-science-with-r/)

[[Руководство по магическим методам в Питоне / Хабр]{.underline}](https://m.habr.com/ru/post/186608/)

[[Стоит ли становиться разработчиком мобильных приложений?]{.underline}](https://proglib.io/p/do-you-need-to-be-mobile-developer/)

[[Тест: какой язык программирования вам стоит выбрать для изучения?]{.underline}](https://tproger.ru/quiz/programming-language-selector/)

[[ТОП-15 трюков в Python 3, делающих код понятнее и быстрее]{.underline}](https://proglib.io/p/python-tricks/)

[[Топ-25 самых рекомендуемых книг по программированию]{.underline}](https://tproger.ru/books/the-25-most-recommended-programming-books-of-all-time/)

[[Функциональное программирование для Android-разработчика. Часть первая]{.underline}](https://tproger.ru/translations/functional-android-1/)

[[Хочу научиться программировать на PHP. С чего начать?]{.underline}](https://tproger.ru/curriculum/php-beginner/)

[[Что лучше изучить: JavaScript стандарта ES5, стандарта ES6 или TypeScript?]{.underline}](https://tproger.ru/translations/es5-es6-or-typescript/)

[[Что такое Kotlin и с чем его едят: обучающее руководство и сравнение нового языка Android-разработки с Java]{.underline}](https://tproger.ru/translations/kotlin-vs-java-android/)
